...
void LeftPanel::init(Json::Value &savedSkills, GUISettings * settings) {
	...
	visibleSize = settings->getVisibleSize();
...
void LeftPanel::createSkillDescription(cocos2d::Node * yLastElement)
{
	...
	skillDescription->setPosition(cocos2d::Vec2(visibleSize.width / 8, yLastElement->getPosition().y - yLastElement->getContentSize().height / 2 -
...
{
	sugarAmount = cocos2d::Label::createWithTTF("X " + savedSkills["holy_sugar"].asString(), "fonts/LICABOLD.ttf", round(visibleSize.width / 25));
...
cocos2d::Label* LeftPanel::createTitle() {
	...
	title->setPosition(cocos2d::Vec2(visibleSize.width / 8, visibleSize.height - title->getContentSize().height * title->getScaleY() / 2 -
		visibleSize.height / 25
	));
...
cocos2d::Label* LeftPanel::createSkillNameLabel(cocos2d::Node* yLastElement) {
	...
	skill_name->setPosition(cocos2d::Vec2(visibleSize.width / 8, yLastElement->getPosition().y -
		yLastElement->getContentSize().height * yLastElement->getScaleY() / 2 -
